...
import io.tictactoe.authentication.infrastructure.emails.{PasswordChangedMailTemplateData, PasswordResetMailTemplateData, RegistrationMailTemplateData}
import io.tictactoe.authentication.infrastructure.services.AuthEmail
